...
fun movieDetailsToVideo(movie: IMovieDetails): IVideo {
    ...
    return IVideo(movie.id.toLong(),movie.video_files[0].extension,movie.title,movie.poster,movie.overview,url,null,movie.video_files[0].subtitles,"movie",movie.id.toLong(),movie.imdb_id)
}